...
You have to design & build the backend for the application and the ability for the users to register and search for services.
...
https://github.com/azaylamba/justdial 
